...
function App() {
  ...
  const handlePredict = async () => {
    ...
    try {
      const response = await axios.get('https://stockpredictor-0lwg.onrender.com/predict', {
        params: {
          ticker,
      ...
      // Fetch news
      const newsResponse = await axios.get('https://stockpredictor-0lwg.onrender.com/news', {
